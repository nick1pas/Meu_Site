...
function CreatePbBar(obj, pbShowBar, pbShowText, pbShowImage, pbText, pbImage, pbBarAbove, isRevert, pbCaption)
{
	...
	if (pbShowBar == false)
	{
		...
		if (pbBarAbove == false)
		{
			if (typeof divTrans.style.filter != 'undefined')
				divTrans.style.filter = "progid:DXImageTransform.Microsoft.Alpha(opacity=50)";
	...
	if (pbCaption != null && pbCaption != "")
	{
		...
		divCapTrans.style.color = "#ffffff";
		divCapTrans.style.borderStyle = "solid";
		divCapTrans.style.borderWidth = "0px";
		...
		divCapTrans.style.backgroundColor = "#000000";
		divCapTrans.style.zIndex = z;
		if (popBoxCaptionBelow == false)
		{
			if (typeof divCapTrans.style.filter != 'undefined')
				divCapTrans.style.filter = "progid:DXImageTransform.Microsoft.Alpha(opacity=90)";
...
var popBoxRevertText = "Clique na imagem para diminuir";
...
var popBoxPopText = "Clique na imagem para ampliar";
